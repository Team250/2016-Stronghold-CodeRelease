...
//		double js = Robot.oi.manipulator.getRawAxis(OI.intakeArmAxis);
//		if (js > Constant.kBINARY_AXIS_DEADBAND.get()) {
//			Robot.intake.moveArm(Constant.kINTAKE_ARM_LOWER_SPEED.get());
//		} else if (js < -Constant.kBINARY_AXIS_DEADBAND.get()) {
//			Robot.intake.moveArm(Constant.kINTAKE_ARM_RAISE_SPEED.get());
//		} else {
//			Robot.intake.stopArm();
//		}
		Robot.intakeArm.moveArm(-Utilities.joystickDeadband(Robot.oi.manipulator.getRawAxis(OI.intakeArmAxis))
				* Constant.kINTAKE_ARM_RAISE_SPEED.get());
	}
