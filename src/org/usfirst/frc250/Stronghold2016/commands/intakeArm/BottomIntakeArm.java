 ...
 *
 */
public class BottomIntakeArm extends Command {

    public BottomIntakeArm() {
    ...
    protected void execute() {
    	Robot.intakeArm.moveArm(Constant.kINTAKE_ARM_LOWER_SPEED.get());
    }

    // Make this return true when this Command no longer needs to run execute()
    protected boolean isFinished() {
        return Robot.intakeArm.isAtBottomLimit();
    }
