...
public class SpinFlywheel extends Command {
	...
	/**
	 * Spins the flywheel at a set speed. Assign to a button, while held, or use
	 * in a command group in parallel with a timeout.
	 */
	public SpinFlywheel() {
	...
	protected void initialize() {
		Robot.shooter.spinWheel(Constant.kFLYWHEEL_FAR_SPEED.get());
	}
