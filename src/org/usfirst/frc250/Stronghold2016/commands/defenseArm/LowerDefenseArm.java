 ...
 *
 */
public class LowerDefenseArm extends Command {
	...
	/**
	 * Lowers the defense arm. Assign to a button, when pressed.
	 */
    public LowerDefenseArm() {
    ...
    protected boolean isFinished() {
        return Robot.defenseArm.isAtBottomLimit();
    }
