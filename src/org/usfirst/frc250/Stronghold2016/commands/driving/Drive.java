...
public class Drive extends Command {
	...
	protected void execute() {
		...
		if (driver.getPOV() == 0) { /* TEST: POV drive */
			Robot.drivetrain.drive(1, 1);
		} else if (driver.getPOV() == 180) {
			Robot.drivetrain.drive(-1, -1);
		} else {
			Robot.drivetrain.drive(-Utilities.joystickDeadband(driver.getRawAxis(OI.leftDriveAxis)),
					-Utilities.joystickDeadband(driver.getRawAxis(OI.rightDriveAxis)));
		}
	}
